    ...
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Login([Bind("userName,password")] Master login)
        {
            ...
            if (data != null)
            {
                ...
                HttpContext.Session.SetString("adminData", data.isCoin+"|"+ data.isJewellery + "|" + data.isKyc + "|" + data.isOtr + "|" + data.isUpdate + "|" + data.isBank + "|" + data.isFeedback + "|" + data.isClientRate + "|" + data.isHistory + "|" + data.isSlider);
