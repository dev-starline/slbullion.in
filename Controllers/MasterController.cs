...
namespace SL_Bullion.Controllers
{
    public class MasterController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,userName,password,isActive,firmName,clientName,mobile,city,domain,symbol,group,versionAndroid,versionIos,isCoin,isJewellery,isKyc,isOtr,isUpdate,isBank,isFeedback,isClientRate,privacyPolicyFile,fcmKey,createDate,modifiedDate")] Master master)
        {
            if (id != master.id)
            {
                return NotFound();
