...
function getBankCalculation() {
    var data = ajaxGet('Symbol/getBankCalculation');
...
$("body").on("click", ".updatePremium", async function () {
    ...
    var response = ajaxPost('Symbol/updatePremium', JSON.stringify(data)); 
...
$("body").on("click", ".saveAll", function () {
    ...
    var response = ajaxPost('Symbol/saveAll', JSON.stringify(array)); 
});
...
function setCommonPremium() {
    ...
    var response = ajaxPost('Symbol/setCommonPremium', JSON.stringify(data));
    if (response == 200) {
    }
}
$(function () {
